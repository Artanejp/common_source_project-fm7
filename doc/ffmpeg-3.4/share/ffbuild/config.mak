...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--cross-prefix=i686-w64-mingw32- --prefix=/usr/local/i586-mingw-msvc/ffmpeg-3.4 --disable-static --enable-shared --target-os=mingw32 --arch=i686 --enable-gpl --enable-libx264 --enable-libvorbis --enable-libmp3lame --enable-dxva2 --extra-cflags='-I/usr/local/i586-mingw-msvc/libx264-152/include -I/usr/local/i586-mingw-msvc/lame-3.99.5/include  -I/usr/local/i586-mingw-msvc/libvorbis/include -I/usr/local/i586-mingw-msvc/libogg/include' --extra-ldflags='-L/usr/local/i586-mingw-msvc/libx264-152/lib -L/usr/local/i586-mingw-msvc/lame-3.99.5/lib -L/usr/local/i586-mingw-msvc/libvorbis/lib -L/usr/local/i586-mingw-msvc/libogg/lib'
...
CC_IDENT=gcc 6.3.0 (GCC) 20170516
ARCH=x86
INTRINSICS=none
...
CFLAGS=  -I/usr/local/i586-mingw-msvc/libx264-152/include -I/usr/local/i586-mingw-msvc/lame-3.99.5/include -I/usr/local/i586-mingw-msvc/libvorbis/include -I/usr/local/i586-mingw-msvc/libogg/include -std=c11 -fomit-frame-pointer -I/usr/local/i586-mingw-msvc/libvorbis/include -I/usr/local/i586-mingw-msvc/libogg/include -I/usr/local/i586-mingw-msvc/libvorbis/include -I/usr/local/i586-mingw-msvc/libogg/include -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -fdiagnostics-color=auto -Wno-maybe-uninitialized
CXXFLAGS=  -D__STDC_CONSTANT_MACROS -std=c++11
OBJCFLAGS=  
ASFLAGS=  -I/usr/local/i586-mingw-msvc/libx264-152/include -I/usr/local/i586-mingw-msvc/lame-3.99.5/include -I/usr/local/i586-mingw-msvc/libvorbis/include -I/usr/local/i586-mingw-msvc/libogg/include -g
...
DOXYGEN=doxygen
LDFLAGS= -L/usr/local/i586-mingw-msvc/libx264-152/lib -L/usr/local/i586-mingw-msvc/lame-3.99.5/lib -L/usr/local/i586-mingw-msvc/libvorbis/lib -L/usr/local/i586-mingw-msvc/libogg/lib  -Wl,--large-address-aware -Wl,--nxcompat,--dynamicbase -Wl,--as-needed -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
LDEXEFLAGS=
LDLIBFLAGS=
...
EXTRALIBS=-lgdi32 -lpsapi -lole32 -lstrmiids -luuid -loleaut32 -lshlwapi -luser32 -lws2_32 -liconv -lvfw32 -luser32 -lsecur32 -lx264 -L/usr/local/i586-mingw-msvc/libvorbis/lib -lvorbisenc -L/usr/local/i586-mingw-msvc/libvorbis/lib -lvorbis -lmp3lame -lm -lz -lpsapi -ladvapi32 -lshell32 -lole32 
COMPAT_OBJS=
INSTALL=install
LIBTARGET=i386
