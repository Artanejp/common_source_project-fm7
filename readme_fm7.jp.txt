...
2.移植状況
  a. FM-7はほぼ動いてますが、「ぎゅぁんぶらぁ自己中心派」のように
     動かないものも稀にあります。
  b. FM-77に関してもほぼ同様ですが、400ラインカードと2HD周りは
     全く実装できていません（現物がないのでどうしょうもない）
  c. FM-8は資料不足で未だ実装できていませんが、遠くない内に実装を
     始めます。
  d. FM77AVはほぼ動くようになりました。
     但し、一部のディスクイメージでRecord Not Foundが発生してしまう
     問題への対処ができてなくて動かないものもあります。

  e. FM77AV40SXについて大まかに実装してみましたが、未だ動きません。
...
3. 動かし方
  ...
  FM77AV20/40では、INITIATE.ROMは、AV20/40固有のものを使ってください。
