...
if(BUILD_PC8001)
	set(RESOURCE ${CMAKE_CURRENT_SOURCE_DIR}/../../../src/qt/common/qrc/pc8001.qrc)
	ADD_VM(pc8801 emupc8001 _PC8001)
endif()
if(BUILD_PC8001MK2)
	set(RESOURCE ${CMAKE_CURRENT_SOURCE_DIR}/../../../src/qt/common/qrc/pc8001mk2.qrc)
	ADD_VM(pc8801 emupc8001mk2 _PC8001MK2)
endif()
if(BUILD_PC8001SR)
	set(RESOURCE ${CMAKE_CURRENT_SOURCE_DIR}/../../../src/qt/common/qrc/pc8001sr.qrc)
	ADD_VM(pc8801 emupc8001sr _PC8001SR)
endif()

if(BUILD_PC8801)
	set(RESOURCE ${CMAKE_CURRENT_SOURCE_DIR}/../../../src/qt/common/qrc/pc8801.qrc)
	ADD_VM(pc8801 emupc8801 _PC8801)
endif()
if(BUILD_PC8801MK2)
	set(RESOURCE ${CMAKE_CURRENT_SOURCE_DIR}/../../../src/qt/common/qrc/pc8801mk2.qrc)
	ADD_VM(pc8801 emupc8801mk2 _PC8801MK2)
endif()
if(BUILD_PC8801MA)
	set(RESOURCE ${CMAKE_CURRENT_SOURCE_DIR}/../../../src/qt/common/qrc/pc8801ma.qrc)
