...
SET(CMAKE_LINKSE  i686-w64-mingw32-ld)
SET(CMAKE_NM  i686-w64-mingw32-llvm-nm)

set(CMAKE_CXX_FLAGS "-target i686-w64-mingw32")
#set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -stdlib=libc++")
#set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -B/u1x/46/Virtual/src/llvm-mingw-src")
#set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -nostdinc++ -nostdinc")
#set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -iprefix /u1x/46/Virtual/src/llvm-mingw-src/")
#set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -I /u1x/46/Virtual/src/llvm-mingw-src/lib/clang/9.0.0/include")
#set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -I /u1x/46/Virtual/src/llvm-mingw-src/i686-w64-mingw32/include/c++/v1")
#set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -I /u1x/46/Virtual/src/llvm-mingw-src/i686-w64-mingw32/include")
