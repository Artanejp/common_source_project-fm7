...
inline UINT8 __FASTCALL read_mem_byte_(i8086_state *cpustate, unsigned a)
{
	int wait = 0;
...
inline UINT16 __FASTCALL read_mem_word_(i8086_state *cpustate, unsigned a)
{
	int wait = 0;
...
inline void __FASTCALL write_mem_byte_(i8086_state *cpustate, unsigned a, UINT8 d)
{
	int wait = 0;
...
inline void __FASTCALL write_mem_word_(i8086_state *cpustate, unsigned a, UINT16 d)
{
	int wait = 0;
...
inline UINT8 __FASTCALL read_port_byte_(i8086_state *cpustate, unsigned a)
{
	int wait = 0;
...
inline UINT16 __FASTCALL read_port_word_(i8086_state *cpustate, unsigned a)
{
	int wait = 0;
...
inline void __FASTCALL write_port_byte_(i8086_state *cpustate, unsigned a, UINT8 d)
{
	int wait = 0;
...
inline void __FASTCALL write_port_word_(i8086_state *cpustate, unsigned a, UINT16 d)
{
	int wait = 0;
