...
0x18	I	O	P	`	[	enter	A	S
0x20	D	F	G	H	J	K	L	:
0x28	;	]	Z	X	C	V	B	N
0x30	M	,	.	/	''	SP	[KP]*	[KP]/
0x38	[KP]+	[KP]-	[KP]7	[KP]8	[KP]9	=	[KP]4	[KP]5
0x40	[KP]6	---	[KP]1	[KP]2	[KP]3	[KP]enter	[KP]0	[KP].
0x48	INS	---	[KP]0	DEL	---	UP↑ 	HOME	←
0x50	↓	→	CTRL	SHIFT	---	CAPS	LANG	ALT
0x58	CTRL	SPACE	LANG	F12	ALT	F1	F2	F3
0x60	F4	F5	F6	F7	F8	F9	F10	---
0x68	---	F11	---	>	SCRL	[KP]-	PgUP	---
0x70	PgDWN	BGN	END	ENTER	=	[KP]-	PgUP	---
0x78							
*/
...
/*	VK -> RAW code table                    +8                                           */
	...
	0x35,0x6E,0x70,0x00,0x4E,0x4F,0x4D,0x51,0x50,0x00,0x7D,0x00,0x00,0x48,0x4B,0x00,/*2x*/
	...
	0x28,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,/*cx*/
