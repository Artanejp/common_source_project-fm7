...
const int I8080_BASE::cc_op_8085[0x100] = {
//#ifdef HAS_I8085
...
const int I8080_BASE::cc_op_8080[0x100] = {
//#else
...
const uint8_t I8080_BASE::ZS[256] = {
...
const uint8_t I8080_BASE::ZSP[256] = {
...
const uint16_t I8080_BASE::DAA[2048] = {
...
void I8080_BASE::JMP(uint8_t c)
{
	if(c) {
		uint16_t a = FETCH16();
		printf("JMP  PC=%04x To=%04x\n", PC, a);
		PC = a;
	} else {
		printf("Not JMP\n");
		PC += 2;
...
void I8080_BASE::CALL(uint8_t c)
{
	if(c) {
		uint16_t a = FETCH16();
		printf("CALL PC=%04x To=%04x\n", PC, a);
		count -= 7;
		PUSH16(PC);
		PC = a;
	} else {
...
void I8080_BASE::ANA(uint8_t v)
{
}

void I8080_BASE::OP(uint8_t code)
{
	uint8_t tmp8;
	uint16_t tmp16;
