...
void MC6809_DEBUG::run_one_opecode()
{
#ifdef USE_DEBUGGER
...
void MC6809_DEBUG::write_debug_data8(uint32_t addr, uint32_t data)
{
#ifdef USE_DEBUGGER
...
uint32_t MC6809_DEBUG::read_debug_data8(uint32_t addr)
{
#ifdef USE_DEBUGGER
...
void MC6809_DEBUG::write_debug_io8(uint32_t addr, uint32_t data)
{
#ifdef USE_DEBUGGER
...
uint32_t MC6809_DEBUG::read_debug_io8(uint32_t addr)
{
#ifdef USE_DEBUGGER
...
uint32_t MC6809_DEBUG::cpu_disassemble_m6809(_TCHAR *buffer, uint32_t pc, const uint8_t *oprom, const uint8_t *opram)
{
#ifdef USE_DEBUGGER
...
int MC6809_DEBUG::debug_dasm(uint32_t pc, _TCHAR *buffer, size_t buffer_len)
{
#ifdef USE_DEBUGGER
