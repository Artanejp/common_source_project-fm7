...
v99x8_device::v99x8_device(VM_TEMPLATE* parent_vm, EMU_TEMPLATE* parent_emu)
...
v9938_device::v9938_device(VM_TEMPLATE* parent_vm, EMU_TEMPLATE* parent_emu)
...
v9958_device::v9958_device(VM_TEMPLATE* parent_vm, EMU_TEMPLATE* parent_emu)
: v99x8_device(parent_vm, parent_emu)
{
	m_model = MODEL_V9958;
	init_palette();
