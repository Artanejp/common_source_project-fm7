...
void M6502_BASE::decl_state_regs()
{
	DECL_STATE_ENTRY_PAIR(pc);
	DECL_STATE_ENTRY_PAIR(sp);
	DECL_STATE_ENTRY_PAIR(zp);
	DECL_STATE_ENTRY_PAIR(ea);
	DECL_STATE_ENTRY_UINT16(prev_pc);
	DECL_STATE_ENTRY_UINT8(a);
	DECL_STATE_ENTRY_UINT8(x);
	DECL_STATE_ENTRY_UINT8(y);
	DECL_STATE_ENTRY_UINT8(p);
	DECL_STATE_ENTRY_BOOL(pending_irq);
	DECL_STATE_ENTRY_BOOL(after_cli);
	DECL_STATE_ENTRY_BOOL(nmi_state);
	DECL_STATE_ENTRY_BOOL(irq_state);
	DECL_STATE_ENTRY_BOOL(so_state);
