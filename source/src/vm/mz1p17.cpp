...
void MZ1P17::draw_char(uint16_t code)
{
	...
	if(IS_KANA(code) && hiragana_mode) {
		static const uint16_t hiragana_sjis[] = {
			...
			0x82e1, 0x82e3, 0x82e5, 0x82c1,		// ゃゅょっ
			0,					// 
			0x82a0, 0x82a2, 0x82a4, 0x82a6, 0x82a8,	// あいうえお
			...
			0x82e2, 0x82e4, 0x82e6,			// やゆよ
			0x82e7, 0x82e8, 0x82e9, 0x82ea, 0x82eb,	// らりるれろ
			0x82ed, 0x82f1,				// わん
		};
