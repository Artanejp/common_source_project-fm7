...
#if defined(HAS_I386) || defined(HAS_I486SX) || defined(HAS_I486DX) || defined(UPPER_I386)
#include "../i386_np21.h"
//#include "../i386.h"
...
//	beep->set_context_debugger(new DEBUGGER(this, emu));
	...
	memory->space = 0x01000000; // 16MB
#elif defined(SUPPORT_32BIT_ADDRESS)
	memory->space = (uint64_t)(0x100000000); // 4GiB
#else
	memory->space = 0x00100000; // 1MB
#endif
