...
void MSM58321_BASE::event_callback(int event_id, int err)
{
...
void MSM58321_BASE::read_from_cur_time()
{
	// update clock
...
void MSM58321_BASE::write_to_cur_time()
{
...
void MSM58321_BASE::write_signal(int id, uint32_t data, uint32_t mask)
{
...
void MSM58321_BASE::set_busy(bool val)
{
//#ifndef HAS_MSM5832
//	if(busy != val) {
...
bool MSM58321_BASE::process_state(FILEIO* state_fio, bool loading)
{
