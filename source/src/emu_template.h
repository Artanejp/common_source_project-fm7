...
public:
	...
	// 20230118 K.O
	virtual void __FASTCALL send_to_midi(uint8_t data, int ch = 0) {}
	virtual bool __FASTCALL recv_from_midi(uint8_t* data, int ch = 0) { return false; }
	...
	virtual bool __FASTCALL send_to_midi_timeout(uint8_t data, int ch = 0, uint64_t timeout_ms = 0) { return true; /* dummy send. */ }
	virtual bool __FASTCALL recv_from_midi_timeout(uint8_t* data, int ch = 0, uint64_t timeout_ms = 0) { return false; }
	...
	virtual void __FASTCALL reset_to_midi(int ch = -1) {}
	...
	virtual void __FASTCALL initialize_midi_device(bool handshake_from_midi = false,
												   ...
												   int ch = 0)
	{}
	//virtual void __FASTCALL ready_receive_from_midi(int ch = 0) {}
	virtual void __FASTCALL ready_send_to_midi(int ch = 0) {}
	virtual void __FASTCALL request_stop_to_receive_from_midi(int ch = 0) {}
	//virtual void __FASTCALL request_stop_to_send_to_midi(int ch = 0) {}
