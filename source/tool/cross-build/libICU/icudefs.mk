...
prefix = /usr/local/i586-mingw-msvc/icu
exec_prefix = ${prefix}
...
cross_compiling = yes
cross_buildroot = /home/whatisthis/src/libicu-57.2/icu/build-cross/../build
...
CXXFLAGS = -std=c++11 $(THREADSCXXFLAGS) 
# CPPFLAGS is for C Pre-Processor flags
CPPFLAGS = -I/usr/local/i586-mingw-msvc/icu/include $(THREADSCPPFLAGS)  -DHAVE_DLOPEN=0 -DU_HAVE_ATOMIC=1 -DU_HAVE_MMAP=0 
...
LDFLAGS = -lc++abi -lunwind -lssp -lmsvcrt $(RPATHLDFLAGS)
...
include $(top_srcdir)/config/mh-mingw
