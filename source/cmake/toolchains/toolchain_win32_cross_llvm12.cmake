...
set(CMAKE_CXX_FLAGS "-target i686-w64-mingw32 -I/opt/llvm-mingw-12/${CMAKE_TOOLCHAIN_PREFIX}/include")
set(CMAKE_C_FLAGS "-target i686-w64-mingw32 -I/opt/llvm-mingw-12/${CMAKE_TOOLCHAIN_PREFIX}/include")
...
# here is the target environment located
set(CMAKE_FIND_ROOT_PATH /opt/llvm-mingw-12/${CMAKE_TOOLCHAIN_PREFIX} /usr/${CMAKE_TOOLCHAIN_PREFIX} )
