...
#set(CMAKE_C_COMPILER   "${CMAKE_TOOLCHAIN_PREFIX}-clang"   "-target ${CMAKE_TOOLCHAIN_PREFIX} -isystem /opt/llvm-mingw-11/${CMAKE_TOOLCHAIN_PREFIX}/include -isystem /usr/local/${CMAKE_TOOLCHAIN_PREFIX}/include")
#set(CMAKE_CXX_COMPILER "${CMAKE_TOOLCHAIN_PREFIX}-clang++" "-target ${CMAKE_TOOLCHAIN_PREFIX} -isystem /opt/llvm-mingw-11/${CMAKE_TOOLCHAIN_PREFIX}/include -isystem /usr/local/${CMAKE_TOOLCHAIN_PREFIX}/include")
...
# here is the target environment located
set(CMAKE_FIND_ROOT_PATH /opt/llvm-mingw-11/${CMAKE_TOOLCHAIN_PREFIX} /usr/${CMAKE_TOOLCHAIN_PREFIX} )
