...
set(WITH_MOUSE ON)
if(BUILD_X1)
	set(RESOURCE ${PROJECT_SOURCE_DIR}/src/qt/common/qrc/x1.qrc)
	ADD_VM(x1 emux1 _X1)
endif()

if(BUILD_X1TURBO)
	set(RESOURCE ${PROJECT_SOURCE_DIR}/src/qt/common/qrc/x1turbo.qrc)
	ADD_VM(x1 emux1turbo _X1TURBO)
endif()
if(BUILD_X1TURBOZ)
	set(RESOURCE ${PROJECT_SOURCE_DIR}/src/qt/common/qrc/x1turboz.qrc)
	ADD_VM(x1 emux1turboz _X1TURBOZ)
endif()

if(BUILD_X1TWIN)
	set(RESOURCE ${PROJECT_SOURCE_DIR}/src/qt/common/qrc/x1twin.qrc)
